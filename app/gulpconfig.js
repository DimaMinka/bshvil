...
var project     = 'bshvil'
  , src         = './src/'
  , build       = './../wp/wp-content/themes/bshvil/'
  , dist        = './dist/'+project+'/'
...
module.exports = {
  ...
  , chunks: { // Chunks are arrays of globs matching source files that combine to provide specific functionality
      scripts: [src+'js/skip-link-focus-fix.js', bower+'owl.carousel/dist/owl.carousel.js', bower+'fancybox/source/jquery.fancybox.js', src+'js/hamburgler.js', src+'js/main.js']
    }
